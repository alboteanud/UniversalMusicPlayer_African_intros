...
//        "http://storage.googleapis.com/automotive-media/music.json";
    ...
    private static final String CATALOG_URL =
        "https://storage.googleapis.com/bucket-alboteanu/muzica_tari_encarta/document.json";
    ...
    private MediaMetadata buildFromJSON(JSONObject json, String basePath) throws JSONException {
        ...
        Log.d("tag", "iconUrl:  " + iconUrl + "       source mp3: " + source);
...
//        LogHelper.e(TAG, "urlString fetch    ", urlString);             //eu
